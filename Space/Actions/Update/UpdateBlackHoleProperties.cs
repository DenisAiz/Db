...
{
    public class UpdateBlackHoleProperties : IPerformingActions
    {
        ...
        public UpdateBlackHoleProperties(ISpaceObjectRepository<SpaceObject> spaceObjectRepository, IConsoleReader consoleReader, ISpaceObjectTypeReader spaceObjectConsoleReader)
        {
        ...
        public void Perform()
        {
            ...
            if (name != null)
            {
                ...
                _spaceObjectConsoleReader.ReadType((BlackHole)item);
