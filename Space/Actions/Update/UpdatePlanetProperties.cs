...
{
    public class UpdatePlanetProperties : IPerformingActions
    {
        ...
        public UpdatePlanetProperties(ISpaceObjectRepository<SpaceObject> spaceObjectRepository, IConsoleReader consoleReader, ISpaceObjectTypeReader spaceObjectConsoleReader)
        {
        ...
        public void Perform()
        {
            ...
            if (name != null)
            {
                ...
                _spaceObjectConsoleReader.ReadType((Planet)item);
