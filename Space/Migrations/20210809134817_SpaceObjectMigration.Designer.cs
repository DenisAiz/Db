...
namespace Space.Migrations
{
    ...
    [Migration("20210809134817_SpaceObjectMigration")]
    partial class SpaceObjectMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Task3.Space.SpaceObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Task3.Space.Asteroid", b =>
                {
                    b.HasBaseType("Task3.Space.SpaceObject");
            ...
            modelBuilder.Entity("Task3.Space.BlackHole", b =>
                {
                    b.HasBaseType("Task3.Space.SpaceObject");
            ...
            modelBuilder.Entity("Task3.Space.Planet", b =>
                {
                    b.HasBaseType("Task3.Space.SpaceObject");
            ...
            modelBuilder.Entity("Task3.Space.Star", b =>
                {
                    b.HasBaseType("Task3.Space.SpaceObject");
            ...
            modelBuilder.Entity("Task3.Space.Asteroid", b =>
                {
                    b.HasOne("Task3.Space.SpaceObject", null)
                        .WithOne()
                        .HasForeignKey("Task3.Space.Asteroid", "Id")
            ...
            modelBuilder.Entity("Task3.Space.BlackHole", b =>
                {
                    b.HasOne("Task3.Space.SpaceObject", null)
                        .WithOne()
                        .HasForeignKey("Task3.Space.BlackHole", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Task3.Space.Planet", b =>
                {
                    b.HasOne("Task3.Space.SpaceObject", null)
                        .WithOne()
                        .HasForeignKey("Task3.Space.Planet", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Task3.Space.Star", b =>
                {
                    b.HasOne("Task3.Space.SpaceObject", null)
                        .WithOne()
                        .HasForeignKey("Task3.Space.Star", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
